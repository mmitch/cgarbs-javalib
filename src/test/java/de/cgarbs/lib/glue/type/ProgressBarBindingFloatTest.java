...
public class ProgressBarBindingFloatTest extends BaseBindingTest
{
	final Float MODEL_GIVEN_VALUE_1 = Float.valueOf(GlueTestDataModel.PROGRESSBAR_MAX_VALUE);
	final Float MODEL_GIVEN_VALUE_2 = Float.valueOf((GlueTestDataModel.PROGRESSBAR_MIN_VALUE + GlueTestDataModel.PROGRESSBAR_MAX_VALUE) / 2);
	...
	{
		setUp(GlueTestDataModel.PROGRESSBAR_FLOAT_ATTRIBUTE, ProgressBarBinding.class);
	}
